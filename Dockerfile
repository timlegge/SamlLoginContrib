...
#        expat-dev libxml2-dev gcc perl-dev musl-dev db-dev \
        krb5-dev libcrypto1.0 libssl1.0 perl-filesys-notify-simple \
        perl-hash-multivalue perl-digest-sha1 perl-crypt-openssl-dsa \
        perl-crypt-openssl-bignum perl-crypt-openssl-rsa \
        perl-crypt-openssl-random perl-class-accessor \
    ...
    apk add perl-crypt-passwdmd5 perl-berkeleydb perl-spreadsheet-xlsx \
        ...
        perl-gssapi perl-time-parsedate --update-cache \
            --repository http://dl-3.alpinelinux.org/alpine/edge/testing/ \
            --allow-untrusted
  #    apk add perl-crypt-passwdmd5 perl-berkeleydb perl-spreadsheet-xlsx perl-xml-easy perl-time-parsedate perl-type-tiny \
 #apk add perl-crypt-passwdmd5 perl-berkeleydb perl-spreadsheet-xlsx perl-xml-easy perl-time-parsedate perl-types-standard perl-algorithm-diff-xs perl-gssapi perl-db_file-lock  --update-cache --repository http://dl-3.alpinelinux.org/alpine/edge/testing/ --allow-untrusted && \
RUN perl -MCPAN -e "DB_File::Lock, Net::SAML2" && \
